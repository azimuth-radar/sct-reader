...
use crate::loaders::euroscope::{position::{Position, Valid}, symbology::SymbologyItemType};
...
pub enum SymbolDrawItem {
    Line {start: (i8, i8), end: (i8, i8)},
    Polygon(Vec<(i8, i8)>),
    Arc {center: (i8, i8), radius: i8, start_angle: i16, end_angle: i16, fill: bool},
    SetPixel((i8, i8))
}
            ...
            if split.len() > 0 {
                match split[0] {
                    ...
                    "LINETO" => {
                        ...
                        draw_items.push(SymbolDrawItem::Line { start: cursor_pos, end: end_point});
